...
var KnownFields = []FieldMeta{
	...
	{Name: FieldTorrentFileSize, Type: FieldTypeInt64,
		...
		SetBy:       []string{"jackett", "metainfo_torrent", "metainfo_magnet", "torrent_session"}},
	...
	{Name: FieldTorrentDownloadDir, Type: FieldTypeString,
		...
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentDownloaded, Type: FieldTypeInt64,
		Description: "All-time downloaded payload in bytes",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentUploaded, Type: FieldTypeInt64,
		Description: "All-time uploaded payload in bytes",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentDownRate, Type: FieldTypeInt64,
		Description: "Current download rate in bytes per second",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentUpRate, Type: FieldTypeInt64,
		Description: "Current upload rate in bytes per second",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentConnSeeds, Type: FieldTypeInt,
		Description: "Connected peers that have the complete torrent. Live connections to this client, unlike torrent_seeds, which is the swarm count an indexer reported",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentConnPeers, Type: FieldTypeInt,
		Description: "Connected peers that do not have the complete torrent",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentETA, Type: FieldTypeInt64,
		Description: "Estimated seconds to completion (absent when the client cannot estimate one)",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentLabel, Type: FieldTypeString,
		Description: "Client-side label or category (absent when unset; needs the Label plugin on Deluge)",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentTrackerHost, Type: FieldTypeString,
		Description: "Host of the torrent's primary tracker (absent when the client reports none)",
		SetBy:       []string{"torrent_session"}},
	{Name: FieldTorrentCompletedAt, Type: FieldTypeTime,
		Description: "When the download finished (absent while incomplete)",
		SetBy:       []string{"torrent_session"}},
