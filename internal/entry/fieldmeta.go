...
var KnownFields = []FieldMeta{
	...
	{Name: "raw_title", Type: FieldTypeString,
		Description: "Original entry title as received from the source, before enrichment",
		SetBy:       []string{"metainfo_series", "movies"}},
	...
	{Name: FieldVideoQuality, Type: FieldTypeString,
		...
		SetBy:       []string{"metainfo_quality", "movies"}},
	...
	{Name: FieldSeriesSeason, Type: FieldTypeInt,
		...
		SetBy:       []string{"metainfo_series", "metainfo_tvdb", "jackett"}},
	...
	{Name: FieldSeriesEpisodeID, Type: FieldTypeString,
		...
		SetBy:       []string{"metainfo_series", "metainfo_tvdb"}},
	...
	{Name: FieldSeriesStatus, Type: FieldTypeString,
		Description: "Series status (e.g. Continuing, Ended)",
		SetBy:       []string{"metainfo_tvdb", "metainfo_trakt"},
		KnownValues: []string{"Continuing", "Ended", "Upcoming", "Pilot"}},
	...
	{Name: FieldSeriesProper, Type: FieldTypeBool,
		Description: "true when the release is tagged PROPER",
		SetBy:       []string{"metainfo_series"}},
	{Name: FieldSeriesRepack, Type: FieldTypeBool,
	...
	{Name: "quality_resolution", Type: FieldTypeString,
		Description: "Resolution sub-field parsed by metainfo_quality",
		SetBy:       []string{"metainfo_quality"}},
	{Name: "quality_source", Type: FieldTypeString,
		Description: "Source sub-field parsed by metainfo_quality",
		SetBy:       []string{"metainfo_quality"}},
