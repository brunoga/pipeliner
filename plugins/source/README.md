...
| [`jackett_input`](jackett_input/README.md) | `jackett_input` | Fetch recent results from Jackett indexers as a passive feed |
...
| [`jackett`](jackett/README.md) | `jackett` | Search Jackett via Torznab (also a search backend for `discover.via`) |
