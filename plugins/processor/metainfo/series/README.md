...
|----------|-------|
| Role | `processor` |
| MayProduce | `title`, `series_season`, `series_episode`, `series_episode_id`, `series_proper`, `series_repack`, `series_double_episode`, `series_service`, `series_container` (set only when the title parses as a series episode) |
| Requires | — |
