...
|----------|-------|
| Role | `processor` |
| Produces | `video_quality`, `video_resolution`, `video_source`, `video_is_3d`, `quality_resolution`, `quality_source` |
| MayProduce | `codec`, `audio`, `color_range` (set only when the corresponding tags are detected in the title) |
| Requires | — |
